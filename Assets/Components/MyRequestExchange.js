...
export default class MyRequestExchange extends Component {
  state = {
    arr: [
      {
        ...
        <View style={styles.profileImg}>
            <Image source={Item.profilepic} style={{width:"100%", height:"100%", }} 
                ...
                <View style={{width:"60%", justifyContent:"center", }}>
                    <Text style={{fontWeight:"bold", color:"black", textAlign:"left", marginLeft:10}}>{Item.name}</Text>
                </View>
                <View style={{width:"20%", justifyContent:"center" }}>
                <Image source={require("../Photos/message.png")} style={{width:"60%", height:"60%",
